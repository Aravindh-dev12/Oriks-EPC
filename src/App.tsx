...
function Home() {
  return (
    <>
      ...
      <section className="wrap visual-strip"><img src="https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=1800&q=88" alt="Solar panels across a renewable energy site" /><div className="visual-stack"><img src="https://images.unsplash.com/photo-1466611653911-95081537e5b7?auto=format&fit=crop&w=1200&q=88" alt="Wind turbines in a renewable energy landscape" /><img src="https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1200&q=88" alt="Electrical transmission infrastructure" /></div></section>
