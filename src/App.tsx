...
function Home() {
  return (
    <>
      ...
      <section className="editorial-visual wrap"><div className="editorial-main"><img src="https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=1800&q=90" alt="Solar energy infrastructure"/><span>01 / RENEWABLE GENERATION</span></div><div className="editorial-side"><div><span className="kicker">BUILT AROUND THE INTERFACE</span><h3>Plant. Evacuation. Grid.</h3><p>One coordinated electrical pathway.</p></div><img src="https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=1200&q=90" alt="Transmission infrastructure"/><span>02 / GRID CONNECTION</span></div></section>
